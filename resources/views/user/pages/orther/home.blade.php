        ...
        <div class="flex-w flex-c-m">
            <div class="size-202 m-lr-auto respon4">
                ...
                <div class="block1 wrap-pic-w">
                    <img src="{{asset('asset/user/images/matna.jpg')}}" alt="IMG-BANNER">
            ...
            <div class="size-202 m-lr-auto respon4">
                <!-- Block1 -->
                <div class="block1 wrap-pic-w">
                    <img src="{{asset('asset/user/images/sr1.jpg')}}" alt="IMG-BANNER">
            ...
            <div class="size-202 m-lr-auto respon4">
                <!-- Block1 -->
                <div class="block1 wrap-pic-w">
                    <img src="{{asset('asset/user/images/sr2.jpg')}}" alt="IMG-BANNER">
